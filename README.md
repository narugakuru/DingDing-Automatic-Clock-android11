## ⏰ DingDing-Automatic-Clock-Android11
基于https://github.com/georgehuan1994/DingDing-Automatic-Clock-in仓库做了一点修改
更新了autojs，tasker软件的版本，解决了软件无法使用的问题，autojs使用下面的版本
...
1. 新增了一个使用QQ邮箱发送邮件的函数

2. 交互使用QQ邮箱替换了网易邮箱

3. 新增了获取部分日志文本的函数

4. 删除了一些在我手机上会导致bug的waitFor，在各个函数间插入了sleep

5. 修复了QQ发送消息的按钮id错误

6. 新增了使用CORP_NAME来选择公司的备用方法
